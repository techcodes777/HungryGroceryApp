...
public class CouponAdp extends RecyclerView.Adapter<CouponAdp.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            txtCoupon = view.findViewById(R.id.txt_coupon);
            txtApply = view.findViewById(R.id.txt_apply);
            txtCoupon = view.findViewById(R.id.txt_titel);
            txtCoupon = view.findViewById(R.id.txt_desc);
            txtCoupon = view.findViewById(R.id.img_code);
        }
    }
